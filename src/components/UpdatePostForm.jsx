    ...
    <div className='container'>
      ...
      <form action='/' onSubmit={postSubmitHandler}>
        <div className='updatePostForm'>
          ...
          <input value={postTitle} onChange={updateTitle} className='input-title' type="text" id="post-title" ref={textInputTitleRef} />
          <label htmlFor="post-body">Body: </label>
          <textarea value={postBody} onChange={updateBody} className='input-body' id="post-body" ref={textInputBodyRef}></textarea>
        </div>
